    ...
    try:
        while zillow.current_price > starting_price-1: 
            ...
            for page_num in range(1,9):
                ...
                #zillow.runPebble(listing_links) #Does not work
                #zillow.runAsync(listing_links) #Works but does not complete all threads
                #zillow.runAsyncByLoop(listing_links) #Works but does not complete all threads
